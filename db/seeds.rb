...
b1 = Bottle.create(brand: "Barefoot",wine_type: "Rose",color: "Pink", year: 500)
b2 = Bottle.create(brand: "Dark Horse", wine_type: "Rose" ,color: "Pink" ,year: 1998)
b3 = Bottle.create(brand: "Kim Crawford", wine_type: "Sauvignon Blanc" ,color: "White" ,year: 1950)
b4 = Bottle.create(brand: "Sineanne", wine_type: "Pinot Gris" ,color: "White" ,year: 1000 )
b5 = Bottle.create(brand: "Husch Anderson Valley" , wine_type: "Pinot Noir",color: "Red" ,year: 607)
b6 = Bottle.create(brand: "Chateau Montelena Napa Valley", wine_type: "Cabernet Sauvignon" ,color: "Red" ,year: 1780)
b7 = Bottle.create(brand: "Veuve Clicquot", wine_type: "Champagne" ,color: "Yellow" ,year: 2010 )
b8 = Bottle.create(brand: "Dom Perignon", wine_type: "Champagne",color: "Yellow",year: 1508)
b9 = Bottle.create(brand: "TY KU", wine_type: "Sake",color: "Black",year: 1770 )
b10 = Bottle.create(brand: "Santa Margherita", wine_type: "Pinot Grigio",color: "White",year: 1860)
